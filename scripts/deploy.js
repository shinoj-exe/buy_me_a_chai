...
async function main() {
  ...
  await contract.connect(from1).buyChai("from1","very nice chai 1",amount);
  await contract.connect(from2).buyChai("from2","very nice chai 2",amount);
  await contract.connect(from3).buyChai("from3","very nice chai 3",amount);
